        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-vento-forest text-white flex items-center justify-center font-bold text-xl shrink-0">1</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-vento-forest text-white flex items-center justify-center font-bold text-xl shrink-0">2</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-vento-forest text-white flex items-center justify-center font-bold text-xl shrink-0">3</div>
              <div>
