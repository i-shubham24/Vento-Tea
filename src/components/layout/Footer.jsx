    ...
    <footer className="bg-vento-forest text-vento-cream pt-16 pb-4 md:pb-6 px-4 overflow-hidden relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12 mb-16">
        ...
        <div className="lg:ml-auto">
          ...
          <a href="https://www.amazon.in/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center border border-white/30 rounded-md p-3 hover:border-vento-gold hover:bg-white/5 transition-all w-32 h-12 bg-white/0">
            <svg viewBox="0 0 100 50" preserveAspectRatio="xMidYMid meet" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-white">
