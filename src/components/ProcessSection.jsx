      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        <div className="w-full md:w-1/2 order-2 md:order-1">
          ...
          <div className="space-y-6">
            <div className="border-l-2 border-vento-forest/20 pl-6 py-2">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          {/* Reduced size by adding aspect ratio and max width */}
          <div className="w-full max-w-sm mx-auto lg:max-w-md aspect-square lg:aspect-[4/5] rounded-[40px] overflow-hidden shadow-2xl relative bg-vento-forest/5">
