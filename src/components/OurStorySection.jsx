...
export default function OurStorySection({ hideCta = false }) {
  ...
  return (
    <section ref={ref} className="py-16 px-4 md:px-8 max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-16 relative overflow-hidden">
      <div className="w-full md:w-1/2 relative">
        <div className="w-full max-w-sm mx-auto lg:max-w-md aspect-square lg:aspect-[4/5] rounded-xl overflow-hidden shadow-2xl relative bg-vento-forest/5 group">
          <motion.img 
      ...
      <div className="w-full md:w-1/2 relative z-10">
        ...
        {!hideCta && (
          <Link to="/about" className="inline-block bg-vento-forest text-vento-cream hover:bg-vento-gold hover:text-vento-forest hover:text-vento-forest hover:border-vento-gold font-bold py-4 px-10 rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-md hover:shadow-xl">
